...
export default function Login() {
  ...
  const [loginMethod, setLoginMethod] = useState<"email" | "phone" | "employee" | "google" | "microsoft" | null>(null);
  const [loading, setLoading] = useState(false);
  const [formData, setFormData] = useState({ email: "", password: "", phone: "", otp: "", employeeId: "" });
  const [otpSent, setOtpSent] = useState(false);

  const demoUsers = [
    { name: "John Doe", role: "Senior Lawyer", email: "john.doe@law.com", id: "EMP-2024-001" },
    { name: "Sarah Smith", role: "Case Manager", email: "sarah.smith@law.com", id: "EMP-2024-002" },
    { name: "Mike Johnson", role: "Legal Assistant", email: "mike.johnson@law.com", id: "EMP-2024-003" },
    { name: "Emma Davis", role: "Admin", email: "emma.davis@law.com", id: "EMP-2024-004" },
    { name: "Robert Wilson", role: "Paralegal", email: "robert.wilson@law.com", id: "EMP-2024-005" },
  ];
    ...
    <div className="w-full h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex-col justify-between p-12">
        <div>
          ...
          <p className="text-xl text-slate-300">Secure case management for legal professionals</p>
        </div>
        ...
        <div className="space-y-8">
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400">End-to-end encryption for all case data</p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-white mb-2">Multiple Login Options</h3>
              <p className="text-slate-400">Choose your preferred authentication method</p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400">Access your cases anytime, anywhere</p>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-yellow-900 border border-yellow-700 rounded-lg p-4 mb-6">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="font-semibold text-yellow-200">🧪 Dev Testing - Quick Access</h3>
                </div>
                <p className="text-yellow-200 text-sm mb-3">Select a personnel to test:</p>
                <div className="space-y-2 max-h-48 overflow-y-auto">
                  {demoUsers.map((user, idx) => (
                    ...
                    >
                      ...
                      <div className="text-xs text-yellow-200">{user.role} • {user.id}</div>
                    </button>
                  ))}
                </div>
              </div>
              ...
              <div className="relative my-4">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-slate-800 text-slate-400">Or use standard login</span>
                </div>
              </div>
